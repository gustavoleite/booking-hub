...
public class RabbitMQConfig {
    ...
    public String getSearchEstablishmentCreatedQueueName() {
        return SEARCH_ESTABLISHMENT_CREATED_QUEUE;
    }

    public String getSearchEstablishmentUpdatedQueueName() {
        return SEARCH_ESTABLISHMENT_UPDATED_QUEUE;
    }

    public String getSearchAffiliationCreatedQueueName() {
        return SEARCH_AFFILIATION_CREATED_QUEUE;
    }

    public String getSearchAffiliationUpdatedQueueName() {
        return SEARCH_AFFILIATION_UPDATED_QUEUE;
    }

    public String getSearchReviewCreatedQueueName() {
        return SEARCH_REVIEW_CREATED_QUEUE;
    }
    ...
    @Bean
    public Queue searchEstablishmentCreatedQueue() {
        return QueueBuilder.durable(SEARCH_ESTABLISHMENT_CREATED_QUEUE).build();
    }

    @Bean
    public Queue searchEstablishmentUpdatedQueue() {
        return QueueBuilder.durable(SEARCH_ESTABLISHMENT_UPDATED_QUEUE).build();
    }

    @Bean
    public Queue searchAffiliationCreatedQueue() {
        return QueueBuilder.durable(SEARCH_AFFILIATION_CREATED_QUEUE).build();
    }

    @Bean
    public Queue searchAffiliationUpdatedQueue() {
        return QueueBuilder.durable(SEARCH_AFFILIATION_UPDATED_QUEUE).build();
    }

    @Bean
    public Queue searchReviewCreatedQueue() {
        return QueueBuilder.durable(SEARCH_REVIEW_CREATED_QUEUE).build();
    }
    ...
    public Binding searchEstablishmentCreatedBinding(
        ...
        return BindingBuilder.bind(searchEstablishmentCreatedQueue)
                .to(catalogExchange).with("establishment.created");
    }
    ...
    public Binding searchEstablishmentUpdatedBinding(
            ...
            @Qualifier("catalogExchange") TopicExchange catalogExchange) {
        return BindingBuilder.bind(searchEstablishmentUpdatedQueue)
                .to(catalogExchange).with("establishment.updated");
    }
    ...
    public Binding searchAffiliationCreatedBinding(
            ...
            @Qualifier("catalogExchange") TopicExchange catalogExchange) {
        return BindingBuilder.bind(searchAffiliationCreatedQueue)
                .to(catalogExchange).with("affiliation.created");
    }
    ...
    public Binding searchAffiliationUpdatedBinding(
            ...
            @Qualifier("catalogExchange") TopicExchange catalogExchange) {
        return BindingBuilder.bind(searchAffiliationUpdatedQueue)
                .to(catalogExchange).with("affiliation.updated");
    }
    ...
    public Binding searchReviewCreatedBinding(
        ...
        return BindingBuilder.bind(searchReviewCreatedQueue)
                .to(reviewExchange).with("review.created");
    }
