...
public interface CatalogEventPublisher {
    ...
    void publishAffiliationCreated(Affiliation affiliation, Professional professional, Establishment establishment);
    void publishAffiliationUpdated(Affiliation affiliation, Professional professional, Establishment establishment);
}
