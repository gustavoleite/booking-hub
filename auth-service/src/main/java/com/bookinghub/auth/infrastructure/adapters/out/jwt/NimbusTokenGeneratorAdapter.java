...
public class NimbusTokenGeneratorAdapter implements TokenGenerator {
    ...
    private RSAPrivateKey getPrivateKey() throws Exception {
        ...
        if (privateKeyResource != null && privateKeyResource.exists()) {
            content = StreamUtils.copyToString(privateKeyResource.getInputStream(), StandardCharsets.UTF_8);
        ...
        try {
            ...
            System.err.println("Failed to load private key, generating fallback: " + e.getMessage());
            return generateAndCacheKey();
        }
    }
