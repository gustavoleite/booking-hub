...
Funcionalidade: Gerenciamento de Estabelecimentos (Salões)
  ...
  Cenário: Tentativa de cadastro com horário de funcionamento inválido
    Quando eu envio uma requisição POST para "/establishments" com o horário de abertura "18:00" e fechamento "09:00"
  ...
  Cenário: Listagem dos meus estabelecimentos
    ...
    Quando eu envio uma requisição GET para "/establishments/my-salons"
  ...
  Cenário: Bloqueio de edição de um salão de outro dono
    Dado que existe um salão com ID "456e4567-e89b-12d3-a456-426614174456" que pertence ao usuário "999e4567-e89b-12d3-a456-426614174999"
    Quando eu envio uma requisição PUT para "/establishments/456e4567-e89b-12d3-a456-426614174456"
