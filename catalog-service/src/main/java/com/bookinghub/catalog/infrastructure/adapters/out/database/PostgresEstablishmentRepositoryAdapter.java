    ...
    private Establishment toDomain(EstablishmentEntity entity) {
        return Establishment.builder()
                ...
                .address(Address.builder()
                        ...
                        .build())
                .defaultBusinessHours(entity.getDefaultBusinessHours() != null ? entity.getDefaultBusinessHours().stream()
                ...
                .providedServices(entity.getProvidedServices() != null ? entity.getProvidedServices().stream()
