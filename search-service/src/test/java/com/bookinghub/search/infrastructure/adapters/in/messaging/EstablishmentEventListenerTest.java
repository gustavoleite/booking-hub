...
class EstablishmentEventListenerTest {
    ...
    @Mock IndexEstablishmentUseCase useCase;
    ...
    @Test
    void onUpdated_shouldAlsoCallUseCaseWithMappedDocument() {
        var event = new EstablishmentEvent("id2", "Salão Novo", null, "RJ", "RJ", null,
        ...
        assertThat(captor.getValue().getLat()).isEqualTo(-22.9);
    }
}
